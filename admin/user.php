...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header" style="font-weight: bold;">System Admin Lists</h3>
					
                </div>
				
				<button class="btn btn-success" data-toggle="modal" data-target="#add_user" style="margin-left: 15px;">Add Admin</button>
