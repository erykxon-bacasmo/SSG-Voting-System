<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom:0; background-color:cadetblue;">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="dashboard.php" style = "color:white; font-weight: Bold;">Supreme Student Government Voting System</a>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu" >
                        ...
                        <li>
                            <a href="dashboard.php"><i class = "fa fa-home fa-large" style="font-size: 20px;"></i> Dashboard </a>
                        </li>
                        <li>
						...
						<li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="../register/index.php"><i class = "fa fa-plus fa-fw"></i> Add Voters</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
