...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
				...
				<hr/>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
							<h4 class = "alert alert-success" style="font-weight: bold;">Canvassing Report</h4>	
                        </div>
			...
			<table class="table table-striped table-bordered table-hover ">
					<thead>
						<td style = "width:400px;" class = "alert alert-success">Candidate for President</td>
						<td style = "width:300px;" class = "alert alert-success">Partylist</td>
	...
	?>
					<tbody> 
						<td style="font-size: 20px;"><?php echo $fetch ['firstname'];?></td>
						<td style="font-size: 20px;"><?php echo $fetch ['lastname'];?></td>
			...
			<table class="table table-striped table-bordered table-hover ">
					<thead>
						<td style = "width:400px;"class = "alert alert-success">Candidate for Vice President for Internal</td>
						<td style = "width:300px;" class = "alert alert-success">Partylist</td>
						<td style = "width:200px;" class = "alert alert-success">Image</td>
						<td class = "alert alert-success">Total</td>
	...
	?>
			...
			<table class="table table-striped table-bordered table-hover ">
					<thead>
						<td style = "width:400px;"class = "alert alert-success">Candidate for Vice President for External</td>
						<td style = "width:300px;" class = "alert alert-success">Partylist</td>
						<td style = "width:200px;" class = "alert alert-success">Image</td>
						<td class = "alert alert-success">Total</td>
	...
	?>
			...
			<table class="table table-striped table-bordered table-hover ">
					<thead>
						<td style = "width:400px;"class = "alert alert-success">Candidate for Secretary</td>
						<td style = "width:300px;" class = "alert alert-success">Partylist</td>
						<td style = "width:200px;" class = "alert alert-success">Image</td>
						<td class = "alert alert-success">Total</td>
	...
	?>
			...
			<table class="table table-striped table-bordered table-hover ">
					<thead>
						<td style = "width:400px;"class = "alert alert-success">Candidate for Auditor</td>
						<td style = "width:300px;" class = "alert alert-success">Partylist</td>
						<td style = "width:200px;" class = "alert alert-success">Image</td>
						<td class = "alert alert-success">Total</td>
	...
	?>
			...
			<table class="table table-striped table-bordered table-hover ">
					<thead>
						<td style = "width:400px;"class = "alert alert-success">Candidate for Treasurer</td>
						<td style = "width:300px;" class = "alert alert-success">Partylist</td>
						<td style = "width:200px;" class = "alert alert-success">Image</td>
						<td class = "alert alert-success">Total</td>
	...
	?>
			...
			<table class="table table-striped table-bordered table-hover ">
					<thead>
						<td style = "width:400px;"class = "alert alert-success">Candidate for PIO</td>
						<td style = "width:300px;" class = "alert alert-success">Partylist</td>
						<td style = "width:200px;" class = "alert alert-success">Image</td>
						<td class = "alert alert-success">Total</td>
	...
	?>
			...
			<table class="table table-striped table-bordered table-hover ">
					<thead>
						<td style = "width:400px;"class = "alert alert-success">Candidate for Peace Officer</td>
						<td style = "width:300px;" class = "alert alert-success">Partylist</td>
						<td style = "width:200px;" class = "alert alert-success">Image</td>
						<td class = "alert alert-success">Total</td>
	...
	?>
			...
			<table class="table table-striped table-bordered table-hover ">
					<thead>
						<td style = "width:400px;"class = "alert alert-success">Candidate for Grade 12 Representative</td>
						<td style = "width:300px;" class = "alert alert-success">Partylist</td>
						<td style = "width:200px;" class = "alert alert-success">Image</td>
						<td class = "alert alert-success">Total</td>
	...
	?>
			...
			<table class="table table-striped table-bordered table-hover ">
					<thead>
						<td style = "width:400px;"class = "alert alert-success">Candidate for Grade 11 Representative</td>
						<td style = "width:300px;" class = "alert alert-success">Partylist</td>
						<td style = "width:200px;" class = "alert alert-success">Image</td>
						<td class = "alert alert-success">Total</td>
	...
	?>
			...
			<table class="table table-striped table-bordered table-hover ">
					<thead>
						<td style = "width:400px;"class = "alert alert-success">Candidate Grade 10 Representative</td>
						<td style = "width:300px;" class = "alert alert-success">Partylist</td>
						<td style = "width:200px;" class = "alert alert-success">Image</td>
						<td class = "alert alert-success">Total</td>
	...
	?>
			...
			<table class="table table-striped table-bordered table-hover ">
					<thead>
						<td style = "width:400px;"class = "alert alert-success">Candidate for Grade 9 Representative</td>
						<td style = "width:300px;" class = "alert alert-success">Partylist</td>
						<td style = "width:200px;" class = "alert alert-success">Image</td>
						<td class = "alert alert-success">Total</td>
	...
	?>
			...
			<table class="table table-striped table-bordered table-hover ">
					<thead>
						<td style = "width:400px;"class = "alert alert-success">Candidate for Grade 8 Representative</td>
						<td style = "width:300px;" class = "alert alert-success">Partylist</td>
						<td style = "width:200px;" class = "alert alert-success">Image</td>
						<td class = "alert alert-success">Total</td>
	...
	?>
			...
			<table class="table table-striped table-bordered table-hover ">
					<thead>
						<td style = "width:400px;"class = "alert alert-success">Candidate for Grade 7 Representative</td>
						<td style = "width:300px;" class = "alert alert-success">Partylist</td>
						<td style = "width:200px;" class = "alert alert-success">Image</td>
						<td class = "alert alert-success">Total</td>
