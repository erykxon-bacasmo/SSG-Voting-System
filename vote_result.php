			...
			if(ISSET($_POST['submit']))
				{
					...
					if(!ISSET($_POST['g12rep_id']))
					{
						$_SESSION['g12rep_id'] = "";
					}
					else
					{
						$_SESSION['g12rep_id'] = $_POST['g12rep_id'];
					}
					...
					if(!ISSET($_POST['g10rep_id']))
					{
						$_SESSION['g10rep_id'] = "";
					}
					else
					{
						$_SESSION['g10rep_id'] = $_POST['g10rep_id'];
					}
					if(!ISSET($_POST['g9rep_id']))
					{
						$_SESSION['g9rep_id'] = "";
					}
					else
					{
						$_SESSION['g9rep_id'] = $_POST['g9rep_id'];
					}
					if(!ISSET($_POST['g8rep_id']))
					{
						$_SESSION['g8rep_id'] = "";
					}
					else
					{
						$_SESSION['g8rep_id'] = $_POST['g8rep_id'];
					}
					if(!ISSET($_POST['g7rep_id']))
					{
						$_SESSION['g7rep_id'] = "";
					}
					else
					{
						$_SESSION['g7rep_id'] = $_POST['g7rep_id'];
					}
				}
		?>
    </div>
		  ...
		  <div class = "alert alert-info">
			...
			<div class = "alert alert-info">
			<label>GRADE 12 REPRESENTATIVE</label>
			<br />
			<?php
				if(!$_SESSION['g12rep_id'])
					{
						
					}
				else
					{
						$fetch = $conn->query("SELECT * FROM `candidate` WHERE `candidate_id` = '$_SESSION[g12rep_id]'")->fetch_array();
						echo $fetch['firstname']." - ".$fetch['lastname']." "."<img src = 'admin/".$fetch['img']."' style = 'height:80px; width:80px; border-radius:500px;' />"; 
					}
			?>
			...
			<div class = "alert alert-info">
			<label>GRADE 10 REPRESENTATIVE</label>
			<br />
			<?php
				if(!$_SESSION['g10rep_id'])
					{
						
					}
				else
					{
						$fetch = $conn->query("SELECT * FROM `candidate` WHERE `candidate_id` = '$_SESSION[g10rep_id]'")->fetch_array();
						echo $fetch['firstname']." - ".$fetch['lastname']." "."<img src = 'admin/".$fetch['img']."' style = 'height:80px; width:80px; border-radius:500px;' />"; 
					}
			?>
			</div>
			<div class = "alert alert-success">
			<label>GRADE 9 REPRESENTATIVE</label>
			<br />
			<?php
				if(!$_SESSION['g9rep_id'])
					{
						
					}
				else
					{
						$fetch = $conn->query("SELECT * FROM `candidate` WHERE `candidate_id` = '$_SESSION[g9rep_id]'")->fetch_array();
						echo $fetch['firstname']." - ".$fetch['lastname']." "."<img src = 'admin/".$fetch['img']."' style = 'height:80px; width:80px; border-radius:500px;' />"; 
					}
			?>
			...
			<div class = "alert alert-info">
			<label>GRADE 8 REPRESENTATIVE</label>
			<br />
			<?php
				if(!$_SESSION['g8rep_id'])
					{
						
					}
				else
					{
						$fetch = $conn->query("SELECT * FROM `candidate` WHERE `candidate_id` = '$_SESSION[g8rep_id]'")->fetch_array();
						echo $fetch['firstname']." - ".$fetch['lastname']." "."<img src = 'admin/".$fetch['img']."' style = 'height:80px; width:80px; border-radius:500px;' />"; 
					}
			?>
			...
			<div class = "alert alert-success">
			<label>GRADE 7 REPRESENTATIVE</label>
			<br />
			<?php
				if(!$_SESSION['g7rep_id'])
					{
						
					}
				else
					{
						$fetch = $conn->query("SELECT * FROM `candidate` WHERE `candidate_id` = '$_SESSION[g7rep_id]'")->fetch_array();
						echo $fetch['firstname']." - ".$fetch['lastname']." "."<img src = 'admin/".$fetch['img']."' style = 'height:80px; width:80px; border-radius:500px;' />"; 
					}
			?>
